  ...
  return (
    <section ref={sectionRef} className={styles.story} id="story">
      ...
      >
        ...
        <p>
          What started as a food-vendor dream now carries the Muerto De Hambre name in Rialto and Lawndale. The original idea is still at the center of it: build something of your own, feed people well, and keep moving forward.
        </p>
      </motion.div>
    </section>
  );
